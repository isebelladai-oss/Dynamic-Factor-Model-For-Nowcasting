...
- [1. 研究背景与问题](#1-研究背景与问题)
- [2. 研究思路](#2-研究思路)
  - [2.1 项目结构与阅读路径](#21-项目结构与阅读路径)
  - [2.2 模型流程总览](#22-模型流程总览)
  - [2.3 月度信息集与交易执行时点](#23-月度信息集与交易执行时点)
  - [2.4 滚动窗口设计](#24-滚动窗口设计)
- [3. 文献基础与方法来源](#3-文献基础与方法来源)
- [4. 数据与变量设计](#4-数据与变量设计)
  - [4.1 数据来源](#41-数据来源)
  - [4.2 变量准备](#42-变量准备)
- [5. 数据预处理](#5-数据预处理)
- [6. 模型框架](#6-模型框架)
  - [6.1 三因子动态因子模型与状态空间表达](#61-三因子动态因子模型与状态空间表达)
  - [6.2 混频处理——Harvey 累加器](#62-混频处理harvey-累加器)
  - [6.3 缺失值处理——缺失值选择矩阵](#63-缺失值处理缺失值选择矩阵)
- [7. 参数估计](#7-参数估计)
  - [7.1 PCA 初始化](#71-pca-初始化)
  - [7.2 其他参数初始化](#72-其他参数初始化)
  - [7.3 EM 迭代与 Quasi-Newton 微调](#73-em-迭代与-quasi-newton-微调)
- [8. 实时更新机制](#8-实时更新机制)
- [9. 模型输出](#9-模型输出)
  - [9.1 GDP nowcasting 输出](#91-gdp-nowcasting-输出)
  - [9.2 债券市场信号输出](#92-债券市场信号输出)
- [10. 实证结果](#10-实证结果)
  - [10.1 训练期内拟合结果](#101-训练期内拟合结果)
  - [10.2 样本外 nowcasting 结果](#102-样本外-nowcasting-结果)
  - [10.3 季度内月份差异](#103-季度内月份差异)
  - [10.4 方向预测准确率](#104-方向预测准确率)
- [11. 债券市场信号检验](#11-债券市场信号检验)
  - [11.1 检验对象](#111-检验对象)
  - [11.2 IC 检验](#112-ic-检验)
  - [11.3 时间序列回归](#113-时间序列回归)
  - [11.4 分层检验](#114-分层检验)
  - [11.5 单边阈值交易](#115-单边阈值交易)
- [12. 总结与局限](#12-总结与局限)
  - [12.1 核心结论](#121-核心结论)
  - [12.2 研究局限](#122-研究局限)
  - [12.3 未来展望](#123-未来展望)
